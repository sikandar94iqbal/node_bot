...
const bot = new SlackBot({
  ...
  token: 'xoxb-520780954817-523184333009-mPb83bDHj61m9u1MO2Y3jWbM',
  name: 'sikandar-bot'
});
...
function single_message(channel, fall, ts, bot_name, colr) {
  ...
  var token = 'token=xoxp-520780954817-523176800977-529037443461-89081b17bb5a2f950e9b8cb1df8f94b8&';
...
function bot_info(bot_id) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    request('https://slack.com/api/bots.info?token=xoxp-520780954817-523176800977-529037443461-89081b17bb5a2f950e9b8cb1df8f94b8&bot=' + bot_id + '&pretty=1', function (error, response, body) {
